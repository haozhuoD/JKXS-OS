...
### 完成情况：通过比赛所有测试用例，针对性能瓶颈进行优化，完成了rootfs、gcc的移植工作
...
+ 目前，我们能够支持busybox、lua、lmbench、libc-test等大赛要求的现实程序。不仅如此，我们也移植了一个精简版的rootfs，并在此基础上支持sh、vi等Linux原生用户程序。更进一步的，我们移植了gcc，从而支持C语言程序的编译与执行，打造了一套贴近现实的用户编辑、工作环境。
...
如有相关技术问题，请联系队长丁浩卓 `2567769508@qq.com`。
