...
// need to change
const IS_HC: bool = false; /* Card is SDHC */

pub struct SDCard<SPIImpl> {
    spi: SPIImpl,
    spi_cs: u32, // 默认为0
    is_hc: bool,
    //dmac: &'a DMAC,
...
impl</*'a,*/ X: SPI> SDCard</*'a,*/ X> {
    pub fn new(
        spi: X,
        spi_cs: u32,
        is_hc: bool, /*, dmac: &'a DMAC, channel: dma_channel*/
    ) -> Self {
        Self {
            spi,
            spi_cs,
